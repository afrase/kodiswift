...
developer, or just coding your first addon, you'll find benefits to using kodiswift.
...
To get a deeper understanding of kodiswift, check out :ref:`routing`,
:ref:`caching` and the complete :ref:`api` reference. For specific code
samples, check out :ref:`patterns`. If you are upgrading from kodiswift, check
out the :ref:`upgrading` page.

For a list of Kodi addons which use kodiswift, see :ref:`poweredby`.
