...
from kodiswift import Module, Addon, NotFoundException
...
def create_plugin_module():
        ...
        with preserve_cwd(os.path.dirname(path)):
            plugin = Addon('Hello Kodi', 'plugin.video.helloxbmc', path)
...
class TestRoute(TestCase):
    #def setUp(self):
        ...
        #sys.argv = ['./addon.py']
        #self.plugin = Addon('Hello Kodi', 'plugin.video.helloxbmc', __file__, TEST_STRINGS_FN)
